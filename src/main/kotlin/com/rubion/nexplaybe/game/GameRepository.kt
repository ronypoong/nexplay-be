...
interface GameRepository : JpaRepository<Game, Long> {
    ...
    @Query("select distinct g from Game g order by g.featured desc, case when g.developer.major = true or g.publisher.major = true then 0 else 1 end, g.discoveryScore desc, g.releaseDate asc")
